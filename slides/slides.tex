...
\tikzset{
  treenode/.style = {align=center, inner sep=3pt, text centered,
    font=\sffamily},
  arn_n/.style = {treenode, black, font=\sffamily, text width=5.5em},% arbre rouge noir, noeud noir
  arn_r/.style = {treenode, red, text width=5.5em, very thick},% arbre rouge noir, noeud rouge
  arn_x/.style = {treenode, green, text width=5.5em }% arbre rouge noir, nil
}
...
\begin{center}
  ...
  level distance = 1.5cm}]
	...
	child { node [arn_x] {\texttt{gcc -O3}}
		    ...
		    edge from parent node [left] {\small \success{$+39,82\%$}}
	}
    ;
\end{tikzpicture}
\end{center}
